                ...
                <div class="row">
                    <div class="mb-2 col-6">
                        ...
                        <input type="text" class="form-control mt-0 pt-0" name="name" id="name"
                            aria-describedby="helpId" value="{{ $category->name }}" placeholder="Enter Name">
                    </div>
                    ...
                    <div class="mb-2 col-6">
                        ...
                        <input type="text" class="form-control mt-0 pt-0" name="slug" id="slug"
                            aria-describedby="helpId" value="{{ $category->slug }}" placeholder="Enter Slug">
                    </div>
                    ...
                    <div class="mb-2 col-12">
                        <div class="form-check">
                            <input class="form-check-input" {{ $category->status == '1' ? 'checked' : '' }} name="status"
                    ...
                    <div class="mb-2 col-12">
                        <div class="form-check">
                            <input class="form-check-input" name="popular" {{ $category->popular == '1' ? 'checked' : '' }}
                    ...
                    <div class="mb-2 col-6">
                        ...
                        <input type="text" class="form-control mt-0 pt-0" name="meta_title" id="meta_title"
                            aria-describedby="helpId" value="{{ $category->meta_title }}" placeholder="Enter Meta Title">
                    </div>
